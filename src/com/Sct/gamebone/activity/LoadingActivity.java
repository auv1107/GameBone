...
public class LoadingActivity extends BaseActivity implements AnimatorListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		bg.setAlpha(0f);
		bg.animate().alpha(1.0f).setDuration(2000).setInterpolator(new DecelerateInterpolator()).setListener(this).start();
	...
	public void onAnimationEnd(Animator arg0) {
		...
		bg.animate().alpha(-1.0f).setDuration(2000).setInterpolator(new AccelerateInterpolator()).setStartDelay(2000).setListener(new AnimatorListener() {
